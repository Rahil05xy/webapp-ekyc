...
def readDetails(contract_type):
    ...
    deployed_contract_address = '0xDbdAC467209EF623a0467098FC1F8a8c7d9eCb31' #hash address to access Shared Data contract
...
def saveDataBlockChain(currentData, contract_type):
    ...
    deployed_contract_address = '0xDbdAC467209EF623a0467098FC1F8a8c7d9eCb31' #contract address
    with open(compiled_contract_path) as file:
        contract_json = json.load(file)  # load contract info as JSON
        contract_abi = contract_json['abi']  # fetch contract's abi - necessary to call its functions
    file.close()
...
def sendMails(email, message):
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as connection:
        email_address = 'taherrahil2@gmail.com'
        email_password = 'dsvrfymdjbdwrhoj'
        connection.login(email_address, email_password)
        connection.sendmail(from_addr="taherrahil2@gmail.com", to_addrs=email, msg="Subject : KYC Access Notification\n\nYour KYC Access by "+message)
